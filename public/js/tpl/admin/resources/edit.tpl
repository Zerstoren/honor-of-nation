<div class="form-horizontal" role="form">
    <div class="form-group">
        <div class="col-sm-2">
            <input type="text" class="form-control with-tooltip coordinate" data-hint="Координаты в формате 100х100" value="{{formatters.fromIdToPlace(resource.pos_id)}}"/>
        </div>
        <div class="col-sm-2">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <input type="number" class="form-control with-tooltip production" data-hint="Базовая добыча" value="{{resource.base}}" />
        </div>
    </div>
